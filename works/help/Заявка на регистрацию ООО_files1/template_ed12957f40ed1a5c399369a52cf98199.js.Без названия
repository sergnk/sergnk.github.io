...
; /* Start:"a:4:{s:4:"full";s:91:"/bitrix/components/altasib/geobase.select.city/templates/.default/script.js?148172580829868";s:6:"source";s:75:"/bitrix/components/altasib/geobase.select.city/templates/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
altasib_geobase.sc_init_handlers = function(){
	if(altasib_geobase.is_mobile){
		$('#altasib_geobase_mb_close a').click(function(event){
		...
		$('.altasib_geobase_cities ul li a').click(function(event){
			event.preventDefault();
		});
...
altasib_geobase.sc_onclk = function(cityid, ctryCode, regionCode){ // altasib_geobase_sc_onclk
	var id = '', cityName = '';
...
altasib_geobase.sc_click = function (code, country, region_code){ // altasib_geobase_sc_click
			...
			if(reqId == altasib_geobase.request_numb){
				...
				if(data == '' || data == null)
					...
					for(var i=0; i < oLength; i++){
						...
						if(typeof sOptVal=='undefined' || BX.util.trim(sOptVal)=='' || sOptVal=='null'){
...
/* End */
;; /* /bitrix/components/altasib/geobase.select.city/templates/.default/script.js?148172580829868*/
